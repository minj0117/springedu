...
public class RestController {
	...
	public Map<String, Person> getMembersJson2() {
		...
		map.put("2", new Person("홍길동", 20));
		map.put("3", new Person("홍길동", 30));
		map.put("4", new Person("홍길동", 40));
		map.put("5", new Person("홍길동", 50));
		map.put("6", new Person("홍길동", 60));
		map.put("7", new Person("홍길동", 70));		
