...
public class BoardFileVO {
	...
	private long fid;						//	FID	NUMBER(10,0)	No		1	파일 아이디
	private long bnum;					//	BNUM	NUMBER(10,0)	Yes		2	게시글 번호
	private String fname;				//	FNAME	VARCHAR2(150 BYTE)	Yes		3	파일명
	private long fsize; 				//	FSIZE	VARCHAR2(45 BYTE)	Yes		4	파일 크기
	private String ftype;			  //	FTYPE	VARCHAR2(50 BYTE)	Yes		5	파일 유형
