...
//const g_bnum = '505'; //게시원글
//const g_rid  = 'test@test.com'; //댓글 작성자 id
//const g_rnickname = '테스터1'; //댓글 작성자 별칭
...
comments.addEventListener("click", (e) => {
  ...
  //수정
    ...
    //2) 댓글 수정 추가
    comment_clone.setAttribute(
      "data-rnum",
      parentComment.getAttribute("data-rnum")
    );
...
function writeComment(e) {
  ...
  //3) 요청메세지
  const rcontent = e.target
    .closest(".comment") //
    .querySelector(".rcontent").innerHTML; //
  const sendData = {};
...
function replyComment(e) {
  ...
  const rcontent = e.target
    .closest(".comment") //
    .querySelector(".rcontent").innerHTML; //
  const prnum = e.target
    .closest(".comment")
    .previousElementSibling.getAttribute("data-rnum");
