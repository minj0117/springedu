	...
	<!-- 로그인 전 -->
		<c:if test="${empty sessionScope.member }">
			<div class="container container-upm">
				<p><a href="${contextPath }"><i id="logo" class="fab fa-reddit"></i></a></p>		
				<p>
					<a href="${url_login }"><fmt:message key="menu.login"/></a><span> | </span><a href="${contextPath }/member/joinForm"><fmt:message key="menu.sign-in"/></a>
				</p>
			</div>
		</c:if>
	...
	<!-- 로그인 후 -->
		<c:if test="${!empty sessionScope.member }">
			<div class="container container-upm">
				<p><a href="${contextPath }"><i id="logo" class="fab fa-reddit"></i></a></p>		
				<p>
					<a href="${url_logout }"><fmt:message key="menu.logout"/></a><span> | </span>
