			...
			<div class="content">
		      ...
		      <ul>
		        ...
		        <li class="btnGrp umode">
		          <form:button id="cancelBtn"  type="button" class="btn btn-outline-success">취소</form:button>
		          <form:button id="saveBtn" type="button" class="btn btn-outline-danger">저장</form:button>
		          <form:button id="listBtn"   type="button" class="btn btn-outline-info">목록</form:button>
		        </li>
		        <!-- 첨부 목록 -->
		        <li>
