		      ...
		      <ul>
		        ...
		        <li class="btnGrp">
		          ...
		          <form:button id="deleteBtn" class="btn rmode btn-outline-info" data-bnum="${requestScope.boardVO.bnum }" data-returnPage="${requestScope.returnPage}">삭제</form:button>
		        	...
		        	<!-- 수정모드 버튼 -->		
		          <form:button id="cancelBtn" class="btn umode btn-outline-success">취소</form:button>
		          <form:button id="saveBtn"   class="btn umode btn-outline-danger" data-returnPage="${requestScope.returnPage}">저장</form:button>
		          ...
		          <c:if test="${!empty files }">
			          <div>
				          <c:forEach var="file" items="${requestScope.files }">
				          	<p id="fileList" style="display:flex">
